...
import { Heart, ArrowRight, ShoppingBag, Plus, Minus } from 'lucide-react';
...
const FavoritesTab: React.FC<FavoritesTabProps> = ({ favourites, onToggleFavourite, onAddToCart }) => {
  ...
  // Product Details View (Overlay for favorites tab)
  if (selectedProduct) {
    return (
    ...
    <div className="flex flex-col h-full px-6 pt-6 pb-28 overflow-y-auto no-scrollbar font-alexandria animate-fadeIn">
      ...
      {favoriteProducts.length === 0 ? (
        <div className="flex-1 flex flex-col items-center justify-center text-center px-10">
          ...
          <h2 className="text-lg font-bold text-app-text mb-6">لا يوجد أي منتجات في المفضلة</h2>
          <button 
            onClick={() => navigate('/')}
