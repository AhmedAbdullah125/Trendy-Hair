  ...
  const currentUser = useMemo(() => {
    if (profileData) {
      return {
        ...
        photo: profileData.photo || 'https://trandyhairapp.com/assets/img/unknown.svg',
      ...
      <div className="flex flex-col h-full animate-fadeIn bg-app-bg font-alexandria">
        ...
        <div className="flex-1 flex items-center justify-center px-6">
          <div className="text-center">
            <div className="w-20 h-20 bg-app-gold/10 rounded-full flex items-center justify-center mx-auto mb-4">
              <Edit2 size={40} className="text-app-gold" />
            </div>
            <h2 className="text-xl font-bold text-app-text mb-2">قريباً</h2>
            <p className="text-sm text-app-textSec">سيتم إضافة ميزة تعديل الحساب قريباً</p>
          </div>
        </div>
      </div>
    );
